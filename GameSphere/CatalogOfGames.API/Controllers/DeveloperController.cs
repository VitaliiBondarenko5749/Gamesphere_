...
public class DeveloperController : ControllerBase
{
    ...
    public async Task<ActionResult<ServerResponse>> AddAsync([FromForm] AddDeveloperDTO addDeveloperDTO)
    {
        try
        {
    ...
    [Authorize(Roles = "Creator, Admin")]
    public async Task<ActionResult<ServerResponse>> DeleteAsync(Guid developerId)
    {
        try
        {
    ...
    public async Task<ActionResult<DeveloperInfoDTO[]>> GetTopTenByNameAsync(string name)
    {
        try
        {
    ...
    [Authorize(Roles = "Creator, Admin")]
    public async Task<ActionResult<ServerResponse>> DeleteFromGameAsync([FromQuery] DeveloperToGameDTO dto)
    {
        try
        {
