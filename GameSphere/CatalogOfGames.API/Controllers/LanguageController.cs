...
public class LanguageController : ControllerBase
{
    ...
    public async Task<ActionResult<ServerResponse>> AddAsync([FromForm] AddLanguageDTO addLanguageDTO)
    {
        try
        {
    ...
    [Authorize(Roles = "Creator, Admin")]
    public async Task<ActionResult<ServerResponse>> DeleteAsync(Guid languageId)
    {
        try
        {
    ...
    public async Task<ActionResult<LanguageInfoDTO[]>> GetTopTenByNameAsync(string name)
    {
        try
        {
