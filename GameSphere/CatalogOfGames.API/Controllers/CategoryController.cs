...
public class CategoryController : ControllerBase
{
    ...
    public async Task<ActionResult<CategoryInfoDTO[]>> GetAllAsync()
    {
        try
        {
    ...
    public async Task<ActionResult<ServerResponse>> AddAsync([FromForm] AddCategoryDTO categoryInsertDTO)
    {
        try
        {
    ...
    [Authorize(Roles = "Creator, Admin")]
    public async Task<ActionResult<ServerResponse>> DeleteAsync(Guid categoryId)
    {
        try
        {
    ...
    public async Task<ActionResult<CategoryInfoDTO[]>> GetTopTenByNameAsync(string name)
    {
        try
        {
    ...
    [HttpPost("AddToGame")]
    [Authorize(Roles = "Creator, Admin")]
    public async Task<ActionResult<ServerResponse>> AddToGameAsync([FromForm] CategoryToGameDTO dto)
    {
        try
        {
