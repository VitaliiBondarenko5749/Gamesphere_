...
public class CommentController : ControllerBase
{
    ...
    [Authorize]
    public async Task<ActionResult<ServerResponse>> DoLikeOperationAsync([FromForm] LikeCommentDTO dto)
    {
        try
        {
    ...
    public async Task<ActionResult<ServerResponse>> CheckExistenceAsync([FromQuery] LikeCommentDTO dto)
    {
        try
        {
    ...
    public async Task<ActionResult<int>> GetCountOfLikesAsync(Guid commentId)
    {
        try
        {
