...
namespace JWTAuthentication.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpPost("Register")]
        public async Task<ActionResult<ServerResponse>> RegisterAsync([FromBody] RegisterViewModel model) // DONE!!!
        {
            try
            {
                ...
                if (response.IsSuccess)
                {
                    ...
                    response.Message = $"{UrlEncoder.Encode(response.Message)}Д{UrlEncoder.Encode(code)}";
        ...
        public async Task<ActionResult<ServerResponse>> DeleteAsync(string username) // DONE!
        {
            try
            {
                ServerResponse response = await userService.DeleteAsync(username);
        ...
        public async Task<ActionResult<ServerResponse>> ConfirmEmailAsync([FromQuery] ConfirmEmailModel model) // DONE. 
        {
            try
            {
                ...
                ServerResponse result = await emailService.ConfirmEmailAsync(model);
